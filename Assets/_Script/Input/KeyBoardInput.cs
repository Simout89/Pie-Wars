...
public class KeyBoardInput : MonoBehaviour
{
    ...
    public bool ctrIsActive;//зажат ли ctrl
    public bool shiftIsActive;//зажат ли sfift
    ...
    public void Update(){
        ...
        if (Input.GetKey(KeyCode.LeftShift)){ //зажатие shift
            this.shiftIsActive = true;
        }else if(Input.GetKeyUp(KeyCode.LeftShift)){//отпустили sfift
